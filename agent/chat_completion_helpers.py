...
from kase_cli.timeouts import get_provider_request_timeout, get_provider_stale_timeout
...
def build_api_kwargs(agent, api_messages: list) -> dict:
    ...
    _is_nous = "kyssta" in agent._base_url_lower
    ...
    if _is_qwen:
        _qwen_meta = {
            "sessionId": agent.session_id or "kase",
...
def try_activate_fallback(agent, reason: "FailoverReason | None" = None) -> bool:
    ...
    try:
        ...
        if not fb_api_key_hint:
            ...
            # _normalize_custom_provider_entry in kase_cli/config.py).
...
def handle_max_iterations(agent, messages: list, api_call_count: int) -> str:
    ...
    try:
        ...
        if _is_nous:
            from agent.portal_tags import kyssta_portal_tags as _portal_tags
