...
projection into Kase' display, approval bridging, transcript projection into
...
"codex_app_server"`. Kase' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("KASE_KANBAN_TASK"):
            kanban_db = spawn_env.get("KASE_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "KASE_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("KASE_HOME", os.path.expanduser("~/.kase")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "kase",
        client_title: str = "Kase",
