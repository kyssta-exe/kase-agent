...
# Matches ${HERMES_SKILL_DIR} / ${KASE_SESSION_ID} tokens in SKILL.md.
# Tokens that don't resolve (e.g. ${KASE_SESSION_ID} with no session) are
# left as-is so the user can debug them.
_SKILL_TEMPLATE_RE = re.compile(r"\$\{(HERMES_SKILL_DIR|KASE_SESSION_ID)\}")
...
def substitute_template_vars(
    ...
    """Replace ${HERMES_SKILL_DIR} / ${KASE_SESSION_ID} in skill content.
    ...
    def _replace(match: re.Match) -> str:
        ...
        if token == "KASE_SESSION_ID" and session_id:
