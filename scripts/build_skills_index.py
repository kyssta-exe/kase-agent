#!/usr/bin/env python3
"""Build the Kase Skills Index — a centralized JSON catalog of all skills.
...
`kase skills search/install` can use it without hitting the GitHub API.
...
# Ensure KASE_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Kase Skills Index...", flush=True)
