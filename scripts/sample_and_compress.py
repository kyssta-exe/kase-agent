...
DEFAULT_DATASETS = [
    "Kyssta/swe-terminus-agent-glm-kimi-minimax",
    "Kyssta/kase-megascience-sft1",
    "Kyssta/Kase-Agent-Thinking-GLM-4.7-SFT2",
    "Kyssta/Kase-Agent-Thinking-GLM-4.7-SFT1",
    "Kyssta/terminal-tasks-glm-kase"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "Kyssta/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload Kyssta/{output_name} {final_output}")
