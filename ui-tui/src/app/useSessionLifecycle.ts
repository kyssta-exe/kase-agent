...
import type { ScrollBoxHandle } from '@kase/ink'
import { evictInkCaches } from '@kase/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.KASE_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
