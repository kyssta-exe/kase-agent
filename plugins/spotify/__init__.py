...
``_check_spotify_available()`` — when the user has not run ``kase auth
spotify``, the tools remain registered (so they appear in ``kase
...
The Spotify auth flow (``kase auth spotify``), CLI plumbing, and docs
