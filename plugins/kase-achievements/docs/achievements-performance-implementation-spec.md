# Kase Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.kase/plugins/kase-achievements/state.json` (existing unlock state)
  - `~/.kase/plugins/kase-achievements/scan_snapshot.json` (new)
  - `~/.kase/plugins/kase-achievements/scan_checkpoint.json` (new)
