# Kase Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.kase/plugins/kase-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.kase/plugins/kase-achievements/scan_checkpoint.json`.
