#!/usr/bin/env python3
"""
SWE Runner with Kase Trajectory Format

A runner that uses Kase-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Kase-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Kase-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Kase format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Kase-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Kase-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Kase Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Kase-Agent's built-in execution environments
    and outputs trajectories in Kase-Agent format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to Kase trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Kase trajectory format
...
def main(
    ...
    """
    Run SWE tasks with Kase trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Kase Trajectory Format")
    print("=" * 60)
