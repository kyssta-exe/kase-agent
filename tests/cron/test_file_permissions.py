...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("kase_cli.config.get_config_path", return_value=config_path), \
             patch("kase_cli.config.ensure_kase_home"):
    ...
    def test_ensure_kase_home_sets_0700(self):
        home = Path(self.tmpdir) / ".kase"
        with patch("kase_cli.config.get_kase_home", return_value=home):
