"""Tests for `kase curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import kase_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated KASE_HOME with real agent-created skills on disk."""
    home = tmp_path / ".kase"
    skills = home / "skills"
    ...
    from kase_cli import curator as curator_cli
