...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from kase_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in KASE_OVERLAYS
        overlay = KASE_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify kase doctor recognizes Xiaomi env vars."""
