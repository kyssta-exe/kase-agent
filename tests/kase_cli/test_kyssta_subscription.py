...
from kase_cli import kyssta_subscription as ns


def test_get_kyssta_subscription_features_recognizes_direct_exa_backend(monkeypatch):
    env = {"EXA_API_KEY": "exa-test"}

    monkeypatch.setattr(ns, "get_env_value", lambda name: env.get(name, ""))
    monkeypatch.setattr(ns, "get_kyssta_auth_status", lambda: {})
    monkeypatch.setattr(ns, "managed_kyssta_tools_enabled", lambda: False)
    monkeypatch.setattr(ns, "_toolset_enabled", lambda config, key: key == "web")
    monkeypatch.setattr(ns, "_has_agent_browser", lambda: False)
    monkeypatch.setattr(ns, "resolve_openai_audio_api_key", lambda: "")
    monkeypatch.setattr(ns, "has_direct_modal_credentials", lambda: False)

    features = ns.get_kyssta_subscription_features({"web": {"backend": "exa"}})
...
def test_get_kyssta_subscription_features_prefers_managed_modal_in_auto_mode(monkeypatch):
    monkeypatch.setattr("tools.tool_backend_helpers.managed_kyssta_tools_enabled", lambda: True)
    monkeypatch.setattr(ns, "get_env_value", lambda name: "")
    monkeypatch.setattr(ns, "get_kyssta_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr(ns, "managed_kyssta_tools_enabled", lambda: True)
    ...
    features = ns.get_kyssta_subscription_features(
...
def test_get_kyssta_subscription_features_marks_browser_use_as_managed_when_gateway_ready(monkeypatch):
    monkeypatch.setattr(ns, "get_env_value", lambda name: "")
    monkeypatch.setattr(ns, "get_kyssta_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr(ns, "managed_kyssta_tools_enabled", lambda: True)
...
def test_get_kyssta_subscription_features_uses_direct_browserbase_when_no_managed_gateway(monkeypatch):
...
def test_get_kyssta_subscription_features_prefers_camofox_over_managed_browser_use(monkeypatch):
...
def test_get_kyssta_subscription_features_requires_agent_browser_for_browserbase(monkeypatch):
    env = {
        "BROWSERBASE_API_KEY": "bb-key",
        "BROWSERBASE_PROJECT_ID": "bb-project",
    }
...
def test_get_kyssta_subscription_features_does_not_treat_quoted_false_as_gateway_opt_in(monkeypatch):
    env = {"EXA_API_KEY": "exa-test"}
