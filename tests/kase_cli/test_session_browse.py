"""Tests for the interactive session browser (`kase sessions browse`).
...
from kase_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """kase sessions browse should be parseable."""
        from kase_cli.main import main as _main_entry
