"""Tests for the kase-tools-as-MCP server module surface.
...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from agent.transports import kase_tools_mcp_server as m
    ...
    def test_exposed_tools_are_safe_subset(self):
        ...
        from agent.transports.kase_tools_mcp_server import EXPOSED_TOOLS
        forbidden = {
    ...
    def test_expected_hermes_specific_tools_listed(self):
        """The Kase-specific tools should be present so users on the
    ...
    def test_kanban_worker_tools_exposed(self):
        """Kanban workers run as `kase chat -q` subprocesses; if they
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.kase_tools_mcp_server as m
