...
Tests the new --gateway mode for kase update, including:
...
class TestGatewayPrompt:
    ...
    def test_writes_prompt_file_and_reads_response(self, tmp_path):
        ...
        with patch.dict(os.environ, {"KASE_HOME": str(hermes_home)}):
            from kase_cli.main import _gateway_prompt
...
class TestRestoreStashWithInputFn:
    ...
    def test_uses_input_fn_when_provided(self, tmp_path):
        ...
        from kase_cli.main import _restore_stashed_changes
...
class TestUpdateCommandGatewayFlag:
    """Verify the gateway spawns kase update --gateway."""
