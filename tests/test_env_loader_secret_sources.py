"""Tests for the secret-source tracking in ``kase_cli.env_loader``.

These cover the small public surface that lets `kase model` / `kase setup`
...
from kase_cli import env_loader  # noqa: E402
