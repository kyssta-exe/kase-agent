"""Kase CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.kase/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Kase"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Kase "       # Response box header label
...
.. code-block:: python
    ...
    from kase_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Kase"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.kase/skins/
...
Drop a YAML file in ``~/.kase/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces KASE_LOGO)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Kase — electric teal and indigo",
        "colors": {
            "banner_border": "#38B2AC",
            "banner_title": "#81E6D9",
            "banner_accent": "#4FD1C5",
            "banner_dim": "#2C7A7B",
            "banner_text": "#E6FFFA",
            "ui_accent": "#4FD1C5",
            "ui_label": "#81E6D9",
            ...
            "prompt": "#E6FFFA",
            "input_rule": "#38B2AC",
            "response_border": "#81E6D9",
            "status_bar_bg": "#1A202C",
            "session_label": "#81E6D9",
            "session_border": "#4A5568",
        },
        "spinner": {
        ...
        "branding": {
            "agent_name": "Kase",
            "welcome": "Welcome to Kase! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Kase ",
            "prompt_symbol": "❯",
