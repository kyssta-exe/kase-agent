"""
Skills configuration for Kase.
`kase skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.kase/config.yaml under:
...
from kase_cli.config import cfg_get, load_config, save_config
from kase_cli.colors import Colors, color
from kase_cli.platforms import PLATFORMS as _PLATFORMS
