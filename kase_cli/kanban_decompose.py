...
Invoked by ``kase kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Kase board.
...
def _profile_author() -> str:
    """Mirror of ``kase_cli.kanban._profile_author``."""
    return (
