...
def _resolve_user(user: Optional[str]) -> str:
    ...
    sys.exit(
        ...
        f"{DEFAULT_USER_ENV} in your environment or ~/.kase/.env."
    )
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Hyperliquid CLI Tool for Kase")
