...
Data file: $KASE_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_KASE_HOME = Path(os.environ.get("KASE_HOME", Path.home() / ".kase"))
DATA_DIR = _KASE_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
