...
Built for [Kase](https://github.com/Kyssta/kase). Usable in any coding agent. Canonical source lives here; synced to [`Kyssta/kase/skills/creative/ascii-video`](https://github.com/Kyssta/kase/tree/main/skills/creative/ascii-video) via PR.
