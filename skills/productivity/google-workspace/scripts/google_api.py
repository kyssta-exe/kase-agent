#!/usr/bin/env python3
"""Google Workspace API CLI for Kase.

Uses the Google Workspace CLI (`gws`) when available, but preserves the
existing Kase-facing JSON contract and falls back to the Python client
...
from _kase_home import get_kase_home
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for Kase")
