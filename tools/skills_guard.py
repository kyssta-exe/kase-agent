...
Trust levels:
  - builtin:   Ships with Kase. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.kase/\.env|\~/\.kase/\.env',
     "hermes_env_access", "critical", "exfiltration",
     "directly references Kase secrets file"),
    ...
    (r'\.kase/config\.yaml|\.kase/SOUL\.md',
     "hermes_config_mod", "critical", "persistence",
     "references Kase configuration files directly"),
