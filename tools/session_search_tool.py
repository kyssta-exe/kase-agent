...
the get_anchored_view / get_messages_around primitives in kase_state.
...
# Third-party integrations tag their sessions with KASE_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from kase_state import DEFAULT_DB_PATH
