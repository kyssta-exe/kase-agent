...
def check_systemd_timing_alignment(drain_timeout: float) -> Optional[Dict[str, Any]]:
    ...
    upgraded kase but never re-ran ``kase setup`` to regenerate
    ...
    try:
        # /proc/self/cgroup gives us "0::/user.slice/.../kase-gateway.service"
    ...
    # that's the common case for kase.
    ...
    # constant in kase_cli/gateway.py.
    headroom = 30.0
