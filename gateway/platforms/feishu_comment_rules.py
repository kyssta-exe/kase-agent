...
Config: ~/.kase/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.kase/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_kase_home()`` helper (KASE_HOME-aware and
...
RULES_FILE = get_kase_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_kase_home() / "feishu_comment_pairing.json"
