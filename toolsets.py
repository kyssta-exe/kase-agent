...
_HERMES_CORE_TOOLS = [
    ...
    # spawned as a kanban worker (KASE_KANBAN_TASK env set) or the current
...
TOOLSETS = {
    ...
    "x_search": {
        "description": (
            ...
            "enable in `kase tools` → X (Twitter) Search."
        ),
        "tools": ["x_search"],
        "includes": []
    },
    ...
    "kanban": {
        "description": (
            ...
            "is spawned by the kanban dispatcher (KASE_KANBAN_TASK env "
    ...
    "composio": {
        "description": "250+ app integrations via Composio.dev (GitHub, Gmail, Slack, Notion, Jira, etc.) — requires COMPOSIO_API_KEY",
        "tools": [
            "composio_execute", "composio_list_actions",
    ...
    # ==========================================================================
    # Full Kase toolsets (CLI + messaging platforms)
    #
    ...
    "kase-cron": {
        # Mirrors kase-cli so cron's "default" toolset is the same set of
        # core tools users see interactively — then `kase tools` filters
        # them down per the platform config. _DEFAULT_OFF_TOOLSETS (moa,
        # homeassistant) are excluded by _get_platform_tools() unless
        # the user explicitly enables them.
        "description": "Default cron toolset - same core tools as kase-cli; gated by `kase tools`",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "kase-email": {
        "description": "Email bot toolset - interact with Kase via email (IMAP/SMTP)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "kase-sms": {
        "description": "SMS bot toolset - interact with Kase via SMS (Twilio)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "kase-gateway": {
        ...
        "tools": [],
        "includes": ["kase-telegram", "kase-discord", "kase-whatsapp", "kase-slack", "kase-signal", "kase-bluebubbles", "kase-homeassistant", "kase-email", "kase-sms", "kase-mattermost", "kase-matrix", "kase-dingtalk", "kase-feishu", "kase-wecom", "kase-wecom-callback", "kase-weixin", "kase-qqbot", "kase-webhook", "kase-yuanbao"]
    }
}
