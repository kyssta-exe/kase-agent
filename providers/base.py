...
def _profile_user_agent() -> str:
    """Return a ``kase-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from kase_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"kase-cli/{_ver}"
    except Exception:
        return "kase-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # kase-cli UA so the catalog endpoint is reachable.
