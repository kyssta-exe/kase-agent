  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Kase community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Kase &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Kase?{' '}
        <a
          href="https://github.com/Kyssta/kase/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/Kyssta" target="_blank" rel="noopener noreferrer">
          Kyssta Discord
        </a>{' '}
