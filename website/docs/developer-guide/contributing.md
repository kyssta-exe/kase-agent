...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Kase — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Kase! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Kase core? Start with [Build a Kase Plugin](../guides/build-a-kase-plugin.md)
- Building a new built-in core tool for Kase itself? Start with [Adding Tools](./adding-tools.md)
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.kase/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.kase` — use `get_kase_home()` from `kase_constants` for code paths and `display_kase_home()` for user-facing messages. See [AGENTS.md](https://github.com/Kyssta/kase/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.

## Cross-Platform Compatibility

Kase officially supports **Linux, macOS, WSL2, and native Windows (early beta — via PowerShell install)**.  Native Windows uses Git Bash (from [Git for Windows](https://git-scm.com/download/win)) for shell commands.  A few features require POSIX kernel primitives and are gated: the dashboard's embedded PTY terminal pane (`/chat` tab) is WSL2-only. The native-Windows path is new and moves fast — if you're doing Windows-heavy dev, expect to hit and fix rough edges.
...
- **Discord**: [discord.gg/Kyssta](https://discord.gg/Kyssta)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License

By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/Kyssta/kase/blob/main/LICENSE).
