...
| | |
|---|---|
| Source | Optional — install with `kase skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Kase |
| License | MIT |
...
```
SCRIPT=~/.kase/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.kase/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
