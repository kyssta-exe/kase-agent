...
| | |
|---|---|
| Source | Optional — install with `kase skills install official/health/neuroskill-bci` |
...
Connect Kase to a running [NeuroSkill](https://neuroskill.com/) instance to read
