...
| | |
|---|---|
| Source | Optional — install with `kase skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Kase |
| License | MIT |
...
The script reads `~/.kase/.env` for two optional defaults:
...
Helper script: `~/.kase/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.kase/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.kase/.env`.
...
```bash
python3 ~/.kase/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.kase/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
