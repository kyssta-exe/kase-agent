...
| | |
|---|---|
| Source | Optional — install with `kase skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Kase (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $HERMES_OSINT_CACHE/icij/ (default: ~/.cache/kase-osint/icij/).
