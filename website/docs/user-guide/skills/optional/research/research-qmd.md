...
| | |
|---|---|
| Source | Optional — install with `kase skills install official/research/qmd` |
...
Kase via the native MCP client. This is the preferred
...
Then configure Kase to connect via HTTP:
