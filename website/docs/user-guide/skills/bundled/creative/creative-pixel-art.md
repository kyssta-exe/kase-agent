...
```python
import sys
sys.path.insert(0, "/home/teknium/.kase/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.kase/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Kase installs package this)
