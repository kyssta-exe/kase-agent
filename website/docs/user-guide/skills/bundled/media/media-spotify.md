...
Control the user's Spotify account via the Kase Spotify toolset (7 tools). Setup guide: https://kase.kyssta.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `kase auth spotify` again.
