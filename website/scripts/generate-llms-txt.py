#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Kase docs site.
...
Both publish at:
  https://kase.kyssta.com/docs/llms.txt
  https://kase.kyssta.com/docs/llms-full.txt
...
SITE_BASE = "https://kase.kyssta.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Kase as a Python Library", None),
        ("guides/use-mcp-with-kase", "Use MCP with Kase", None),
        ("guides/use-voice-mode-with-kase", "Use Voice Mode with Kase", None),
        ("guides/use-soul-with-kase", "Use SOUL.md with Kase", None),
        ("guides/build-a-kase-plugin", "Build a Kase Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Kase"),
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by Kyssta. A terminal-native "
    ...
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/Kyssta/"
        "kase/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/Kyssta/kase")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Kase — Full Documentation\n",
        (
            "This file is the entire Kase documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Kase, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://kase.kyssta.com/docs\n",
        "Short index: https://kase.kyssta.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
