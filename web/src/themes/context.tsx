...
const STORAGE_KEY = "kase-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `kase_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "kase-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-kase-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-kase-theme-font", "true");
