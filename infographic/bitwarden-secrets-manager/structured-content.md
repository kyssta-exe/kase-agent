# Kase-Agent PR #30035 — Bitwarden Secrets Manager Integration

## Hero
**ONE TOKEN, EVERY KEY**
Rotate once. Every Kase process picks it up on next start.
...
### CLI Surface
- `kase secrets bitwarden setup`     wizard
- `kase secrets bitwarden status`    diagnose
- `kase secrets bitwarden sync`      dry-run / --apply
- `kase secrets bitwarden install`   binary only
- `kase secrets bitwarden disable`   off switch

### Source of Truth
- Bitwarden WINS on every Kase start
...
10 files changed · +1743 / -1 · agent/secret_sources/ · kase_cli/secrets_cli.py · tests · docs
